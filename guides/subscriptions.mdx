...
active/trialing → canceled (immediate) or cancel_at_period_end → expired
```
...
| `canceled` | No | Subscription was canceled immediately |
| `expired` | No | Subscription period ended or all retries exhausted |
